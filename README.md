...
<div align="center">
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:8BC34A,100:2E7D32&height=3&width=100%" />
</div>
...
```mermaid
flowchart LR
    A["👨‍🌾 Farmer<br/>(Voice / Text / Image)"] --> B["🖥️ Frontend<br/>HTML • CSS • JavaScript"]
    B --> C["⚙️ Backend<br/>Node.js + Express"]
    C --> D["🧠 Gemini 1.5 Flash<br/>AI Engine"]
    C --> E[("🗄️ MongoDB<br/>Chat History & Profiles")]
    D --> C
    E --> C
    C --> B
    B --> A
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:8BC34A,100:2E7D32&height=120&section=footer" width="100%"/>
